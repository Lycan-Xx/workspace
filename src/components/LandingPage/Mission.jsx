  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-[3rem] font-bold mb-4 text-orange-500">{currentTranslation.title}</h2>
          <p className="max-w-2xl text-[1.2rem] mx-auto text-gray-600">{currentTranslation.description}</p>
        </motion.div>
