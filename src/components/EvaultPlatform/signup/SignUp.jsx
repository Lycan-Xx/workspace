      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-4 pt-4">
          ...
          <button
            ...
            } text-white rounded-lg font-medium bg-[#025798] hover:bg-white text-white hover:text-[#025798] transition duration-300 border-2 border-[#025798] rounded-lg ease-linear`}
          >
            Continue
          </button>
        </div>
