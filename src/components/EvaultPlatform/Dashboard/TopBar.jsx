...
const TopBar = ({ setSelectedTab, onSettingSelect }) => {
  ...
  return (
    <div className="w-full max-w-full overflow-hidden"> {/* Add max-w-full and overflow-hidden */}
      <div className="bg-blue-600 rounded-lg shadow-sm p-4 mb-4 mx-2"> {/* Add mx-2 for margin */}
        <div className="flex items-center justify-between flex-wrap gap-2"> {/* Add flex-wrap and gap-2 */}
